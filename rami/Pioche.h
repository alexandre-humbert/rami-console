// Classe Pioche réalisée par Alexandre Humbert
...
public:
	...
	void defausserCarte(Carte c);//On peut defausser une carte et ainsi l'ajouter à la défausse.
	Carte prendreDefausse();//On peut prendre la carte de la défausse avec prendreDefausse.
	~Pioche();
};
